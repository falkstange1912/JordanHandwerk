...
const CONFIG = {
  ...
  brandName: "JORDAN.HANDWERK",
  brandSubtitle: "MEISTERBETRIEB FÜR MODERNES HANDWERK & BAU",
  badgeText: "EXKLUSIVER DESIGN-ENTWURF",
  headlinePart1: "Echtes Handwerk. ",
  headlinePart2: "Präzise umgesetzt.",
  subheadline: "Ein maßgeschneidertes, digitales Kundensystem für Jordan.Handwerk. Entwickelt, um meisterhafte Qualität online sichtbar zu machen, neue Fachkräfte zu begeistern und Projektanfragen komplett digital zu organisieren.",
...
export default function App() {
  ...
  const [applicantCount, setApplicantCount] = useState<number>(16);
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-neutral-950 font-sans antialiased selection:bg-orange-600/10 selection:text-orange-900">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="bg-neutral-900 text-white uppercase text-[10px] tracking-widest font-semibold px-5 py-3 hover:bg-neutral-800 active:scale-98 transition-all duration-200 shadow-sm cursor-pointer"
            >
              Konzept öffnen
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
              <button 
                onClick={() => setDemoActive(true)}
                className="group w-full sm:w-auto bg-neutral-950 hover:bg-neutral-850 text-white text-xs uppercase tracking-widest font-bold px-8 py-4.5 text-center transition-all duration-200 flex items-center justify-center space-x-2 shadow-md hover:shadow-lg active:scale-98 cursor-pointer"
              >
              ...
              {[
                {
                  ...
                  title: "Blitz-Kurzbewerbung",
                  desc: "Fachkräfte, Gesellen oder Quereinsteiger bewerben sich mobil am Smartphone in nur 60 Sekunden – komplett ohne Anschreiben und Papierkram."
                },
                {
                  icon: <CalendarRange className="w-4 h-4 text-orange-600" />,
                  title: "Interaktiver Projektplaner",
                  desc: "Kunden können Maße, Anforderungen und Fotos des Vorhabens direkt hochladen. Das System filtert und strukturiert alle Anfragen automatisch."
                }
              ].map((feat, idx) => (
                <motion.div 
                  key={idx}
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-inner border border-neutral-200/80 aspect-[4/3] bg-neutral-50 group">
                ...
                <div className="absolute bottom-3 left-3 text-white pointer-events-none">
                  ...
                  <span className="text-xs font-semibold tracking-wide">Meisterbetrieb & Ausführung</span>
                </div>
              </div>
            ...
            >
              <div className="space-y-4 text-center">
                ...
                <p className="text-neutral-500 text-xs leading-relaxed">
                  Dieses digitale System befindet sich im exklusiven Demo-Modus für Jordan.Handwerk. Nach Freischaltung werden alle interaktiven Planungsformulare, Materialauswahlen und Bewerbungs-Schnittstellen voll funktionsfähig geschaltet.
                </p>
                ...
                <div className="p-3.5 bg-neutral-50 rounded-xl border border-neutral-200 text-left font-mono text-[10px] text-neutral-500 space-y-1">
                  ...
                  <div className="text-orange-700 font-bold">- Automatisierter WhatsApp-Bewerbungskanal für Gesellen</div>
                  <div className="text-neutral-800 font-semibold">- Live-Schnittstelle zur Material- und Terminabstimmung</div>
                </div>
